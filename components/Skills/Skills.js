...
import { findMenuRef, SKILLS } from "../../constants";
        ...
        <div className="flex flex-col skills-wrapper">
          <div className="flex flex-col">
            ...
            <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
              I specialize in building intelligent solutions using Python,
          ...
          <div className="mt-10">
            ...
            <div className="flex items-center flex-wrap gap-6 staggered-reveal">
              {SKILLS.programmingAndMarkupLanguages.map((skill) => (
                <Image
                  key={skill}
